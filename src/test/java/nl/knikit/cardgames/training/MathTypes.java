...
public class MathTypes {
	...
	public static void new_main(String[] args) {
		...
		// to the yth power.
		System.out.println("pow(2.0, 0.0) is " + Math.pow(2.0, 0.0));
		System.out.println("pow(2.0, 1.0) is " + Math.pow(2.0, 1.0));
		System.out.println("pow(2.0, 2.0) is " + Math.pow(2.0, 2.0));
		System.out.println("pow(2.0, 3.0) is " + Math.pow(2.0, 3.0));
		System.out.println("pow(2, 3.0) is " + Math.pow(2, 3.0));
		System.out.println("pow(2.0, 3) is " + Math.pow(2.0, 3));
		System.out.println("pow(2, 3) is " + Math.pow(2, 3));
		System.out.println("(int) pow(2.0, 3.0) is " + (int) Math.pow(2.0, 3.0));
