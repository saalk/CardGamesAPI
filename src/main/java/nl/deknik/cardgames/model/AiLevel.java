 ...
 * {@link nl.deknik.cardgames.model.Player Player}s that are bots. AiLevel is an enum
...
public enum AiLevel {
    ...
    LOW("Dumb", "Dom"), MEDIUM("Avarage", "Gemiddeld"), HIGH("High", "Hoog");
     ...
     */
    public static Set<AiLevel> aiLevels = EnumSet.of(LOW, MEDIUM, HIGH);
