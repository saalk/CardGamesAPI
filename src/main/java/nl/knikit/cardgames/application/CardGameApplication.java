...
package nl.knikit.cardgames.application;


import nl.knikit.cardgames.controller.CardGamesController;
...
public class CardGameApplication extends Application {
    ...
    */
/**
     * Add your own resources here currently on HomeController.
     *//*


    private void addRestResourceClasses(final Set<Class<?>> resources) {
        resources.add(CardGamesController.class);
    }
