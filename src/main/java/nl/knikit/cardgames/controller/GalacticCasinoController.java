...
//        System.out.println(
//                "> You're the " + number + "th visitor today " + visitor.getAlias() + "; fromLabel 1000 chips for free!");
...
//                action = new String[]{"Stay and fromLabel another 500 chips for free!", "Cash and leave"};
